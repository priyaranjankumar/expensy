                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="card p-5 group hover:shadow-xl transition-all duration-300">
                        ...
                        <div className="mt-3 flex items-center gap-1 text-xs text-slate-500 dark:text-slate-400">
                            <span className="font-medium">{metrics.expense_count}</span> expenses tracked
                        </div>
                    </div>
                    ...
                    <div className="card p-5 group hover:shadow-xl transition-all duration-300">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-xs text-slate-500 dark:text-slate-400 font-medium uppercase tracking-wider">Remaining</p>
                            ...
                            <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-white shadow-lg ${metrics.remaining < 0
                        ...
                        <div className="mt-3 h-1.5 bg-slate-100 dark:bg-dark-700 rounded-full overflow-hidden">
                            <div
                    ...
                    <div className="relative overflow-hidden card p-5 group hover:shadow-xl transition-all duration-300">
                        ...
                        <div className="relative">
                            <div className="flex items-start justify-between">
                                <div>
                                    <p className="text-xs text-red-600 dark:text-red-400 font-medium uppercase tracking-wider">Unpaid</p>
                                    <p className="text-2xl font-bold text-red-600 dark:text-red-400 mt-1">{formatCurrency(metrics.total_unpaid)}</p>
                                </div>
                                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center text-white shadow-lg shadow-red-500/30">
                                    ⏳
                                </div>
                            </div>
                            <div className="mt-3 h-1.5 bg-red-100 dark:bg-red-900/30 rounded-full overflow-hidden">
                                <div
                    ...
                    <div className="relative overflow-hidden card p-5 group hover:shadow-xl transition-all duration-300">
                        ...
                        <div className="relative">
                            <div className="flex items-start justify-between">
                                <div>
                                    <p className="text-xs text-green-600 dark:text-green-400 font-medium uppercase tracking-wider">Paid</p>
                            ...
                            <div className="mt-3 h-1.5 bg-green-100 dark:bg-green-900/30 rounded-full overflow-hidden">
                                <div
